...
public class TrashCanException extends OwingException {
    ...
    private TrashCanException(UniverseErrorCode errorCode, String description) {
        super(errorCode, description);
    }

    public static TrashCanException of(UniverseErrorCode errorCode) {
        return new TrashCanException(errorCode, null);
    }

    public static TrashCanException of(UniverseErrorCode errorCode, String description) {
