package com.owing.entity.domains.story.error;
...
public enum StoryErrorCode implements OwingErrorCode {
    ...
    STORY_NOT_FOUND(OwingHttpStatus.NOT_FOUND, "001", "등장인물을 찾을 수 없습니다.");

    private final OwingHttpStatus status;
    private final String code;
    private final String message;

    StoryErrorCode(OwingHttpStatus status, String code, String message) {
        this.status = status;
